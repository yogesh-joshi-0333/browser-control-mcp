...
export const consoleLogsTool: ITool = {
  ...
  options: {
    ...
    description: 'Get captured JavaScript console logs from the current page. Extension mode returns logs captured since the content script loaded. Headless mode returns logs since the Puppeteer session started.',
